...
timestamp <- args[[6]];#will be added to img name to avoid web page caching
...
ggsave(path = paste0(runs.dir, runID, "/tmp/"), device = "png", filename = paste0("qc_metrics_",  timestamp, ".png"), plot = p)
